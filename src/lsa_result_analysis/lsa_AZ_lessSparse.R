...
sqlSave(connHandle, AZ_df.new, tablename='dbo.temp_AZ_df_new', rownames=FALSE)
close (connHandle);


## ==========================================================================
## Save AZ_df.new into athena_dev
## ==========================================================================
...
myMatrix <- as.textmatrix(LSAspace.tdm.sp)
...
dist.lsa.mat <- as.matrix(dist.lsa)

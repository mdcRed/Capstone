...
cols <- c("Legend name"="#000000","5-stars business and 5-star review"="#66a61e", "5-star business and 1-star review"="#E7298a")
...
ggplot() + 
  ...
  geom_point(data=five_five_rankDf,aes(x = lda_topic, y = cnt, colour="5-stars business and 5-star review"), size=3 )+
  geom_point(data=five_one_rankDf,aes(x = lda_topic,  y = cnt, colour="5-star business and 1-star review"), size=3 ) +
  coord_trans(y="log10") +
  theme_bw()  + 
